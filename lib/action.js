...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const squashMessageIdentifier = core.getInput('squash_message_identifier') || '';
        const squashMessageSeperator = core.getInput('squash_message_seperator') || '\n';
        ...
        if (customTag) {
            ...
            if (squashCommit) {
                ...
                yield Promise.all(commits.map((commit) => __awaiter(this, void 0, void 0, function* () {
                    var _a;
                    if (commit) {
                        if ((_a = commit === null || commit === void 0 ? void 0 : commit.message) === null || _a === void 0 ? void 0 : _a.includes(squashMessageIdentifier)) {
                            ...
                            processedCommits.push(Object.assign({}, commit));
                        }
                    }
                })));
